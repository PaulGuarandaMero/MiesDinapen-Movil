...
//            System.out.println(query);
            ...
            if(responseCode== HttpURLConnection.HTTP_OK){
                ...
                in.close();
                result= sb.toString();
                Log.e("TAG", "insertarIncidencia1: "+ result );
            }
            else{
                result= new String("Error: "+ responseCode);
                Log.e("TAG", "insertarIncidencia2: "+ result );
    ...
    private void insertarFoto(Foto foto){
        String wsURL = Url2;
        URL url = null;
        try {
            // se crea la conexion al api: http://localhost:15009/WEBAPIREST/api/persona
            ...
            //crear el objeto json para enviar por POST
            String query ="{\n" +
                    ""+"\"IDIntervencion\":"+ foto.getIdIncidentes() +"," +
                    "\n \"FotoIncidente\":\""+ foto.getFile()+"\","+
...
//            System.out.println(query);
    ...
    private void insertarAudio(Audio audio){
        String wsURL = Url3;
        URL url = null;
        try {
            // se crea la conexion al api: http://localhost:15009/WEBAPIREST/api/persona
